...
<div class="urls-container">
    <div class="urls-header">
        <div>
            ...
            <p class="urls-subtitle">Showing {{ $urls->firstItem() ?? 0 }} to {{ $urls->lastItem() ?? 0 }} of {{ $urls->total() }} results</p>
        </div>
        <a class="urls-action-link" href="{{ route('admin.dashboard') }}">Back to Dashboard</a>
    </div>
